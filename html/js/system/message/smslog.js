		...
		$(document).ready(function(){
			layui.use(['table','element','layer','form','laydate'], function(){
				  ...
				  var tab = table.render({
					elem: '#LAY_table_user'
					,url: 'index.php?m=system&c=message&a=getSmsLog'
					,where:  {
					...
					,cols: [[
					  ...
					  ,{field:'sms_len', title: '短信字数',"width":100}
					  ,{field:'sms_count', title: '短信条数',"width":100}
					  ,{field:'type', title: '短信类型',"width":100}
					  ,{field:'sms_content', title: '短信内容',"width":900}
					]]
					,id: 'testReload'
					,page: true
					,limits: [20, 50, 100]
