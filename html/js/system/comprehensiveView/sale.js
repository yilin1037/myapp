		...
		$(document).ready(function(){
			layui.use(['table','element','layer','form','laydate'], function(){
				  ...
				  var tab = table.render({
					elem: '#LAY_table_user'
					,url: 'index.php?m=system&c=comprehensiveView&a=sale_getData'
					,cols: [[
					  ...
					  ,{field:'prd_sku_name', title: '销售属性',"width":140}
					  ,{field:'cus_name', title: '客户',"width":120, "templet": '#sexTpl'}
				  ...
				  table.on('tool(user)', function(obj){
					...
					if(obj.event === 'detail'){				//收款
						layer.open({																																											
							...
							success:function(){
								$.ajax({
									url: "/index.php?m=system&c=comprehensiveView&a=sale_getOrder",
									data: {sa_no:data.sa_no},
									dataType: "json",
									type: "POST",
