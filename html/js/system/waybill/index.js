        ...
        layui.use(['element', 'layer', 'form', 'layedit', 'laydate'], function () {
            ...
            jqtb = $('#dateTable').DataTable({  //dateTable 模块 入口
                ...
                "columns": [ //定义列数据来源  id, userid,username,mobile,create_login_time,STATUS
                    {'title': "序号", 'data': "id"},
                    {'title': "日期", 'data': "title",'width':'150px'},
                    {'title': "代发客户", 'data': "prd_no",'width':'150px'},
                    {'title': "昵称", 'data': "num_iid",'width':'100px'},
                    {'title': "快递", 'data': "title",'width':'150px'},
                    {'title': "运单号", 'data': "title",'width':'150px'},
                    {'title': "发货类型", 'data': "title",'width':'150px'},
                    {'title': "发货网点", 'data': "title",'width':'150px'},
                    {'title': "所属店铺", 'data': "title",'width':'150px'},
                    {'title': "代发商家", 'data': "title",'width':'150px'},
                    {'title': "昵称", 'data': "num_iid",'width':'150px'},
                    {'title': "费用（元）", 'data': "title",'width':'150px'},
                    {'title': "扣费", 'data': "title",'width':'100px'},
                    {'title': "物流", 'data': "title",'width':'600px'},
                ],
                'columnDefs': [{
						'targets': 12,
						'searchable': false,
					...
					},
					{
						...
						'className': 'dt-body-center',
						'render': function (data, type, full, meta) {
							return '<div style="width:300px"><div style="float: left;margin-right: 5px;">交易号：14372737939829839</div><div style=" float: left;width: 45px;" class="yes">已发货</div><div style=""><a id=' + full.id + ' class="table-address"  style="color: rgb(18, 150, 219); font-size: 14px; margin-left: 4px; cursor: pointer;">查看物流</a></div></div>';
