...
var dataList = {
    ...
    cols: [
        [
            { type: 'numbers', width: 100, title: '序号' }, { field: 'system_id', width: 150, title: '代拿客户系统号' }, { field: 'system_name', width: 120, title: '代拿客户名称' }, { field: 'bat_no', minWidth: 140, title: '波次号' }, { field: 'create_time', width: 160, title: '创建时间' }, { field: 'total_fee', width: 120, title: '应到金额' }, { field: 'take_fee', width: 120, title: '到货金额' }, { field: 'take_tid_fee', width: 120, title: '代拿费用' }, { field: 'payment', width: 120, title: '已付款金额' }, { field: 'payment_time', width: 160, title: '付款时间' }, { field: 'status_now', width: 100, title: '当前状态' }, { field: 'status', width: 350, title: '操作', align: 'center', toolbar: '#barDemo' }
        ]
    ],
    id: 'dataList',
    data: [],
...
var tidItemsList = {
    ...
    cols: [
        [
            { type: 'numbers', width: 50 }, { field: 'show_tid', minWidth: 120, title: '订单号' }, { field: 'unique_code', width: 120, title: '唯一码' }, { field: 'title', minWidth: 120, title: '商品名称' }, { field: 'sku_name', minWidth: 120, title: '商品属性' }, { field: 'prd_no', minWidth: 120, title: '商品编码' }, { field: 'take_status', minWidth: 100, title: '拿货状态' }, { field: 'take_price', minWidth: 100, title: '拿货单价' }, { field: 'price', minWidth: 100, title: '代拿费用' }, { field: 'system_name', width: 120, title: '代拿客户名称' }, { field: 'username', width: 100, title: '拿货人员' }, { field: 'print_type', width: 100, title: '打印状态' }, { field: 'is_refund', width: 100, title: '是否退款' }, { field: 'ishave', width: 100, title: '是否取货' }
        ]
    ],
    id: 'tidItemsList',
    data: [],
...
var tidPrdList = {
    ...
    cols: [
        [
            { type: 'numbers', width: 50 }, { field: 'title', minWidth: 120, title: '商品名称' }, { field: 'sku_name', minWidth: 120, title: '商品属性' }, { field: 'prd_no', minWidth: 120, title: '商品编码' }, { field: 'take_price', minWidth: 100, title: '拿货单价' }, { field: 'price', minWidth: 100, title: '代拿费用' }, { field: 'num', minWidth: 100, title: '应到数量' }, { field: 'take_num', minWidth: 100, title: '实到数量' }, { field: 'take_fee', minWidth: 100, title: '实到金额' }
        ]
    ],
    id: 'tidPrdList',
    data: [],
...
var paymentDataList = {
    ...
    cols: [
        [
            { type: 'numbers', width: 50 }, { field: 'bat_no', width: 250, title: '波次', event: 'setSign', style: 'cursor: pointer;' }, { field: 'system_name', width: 120, title: '商品名称', event: 'setSign', style: 'cursor: pointer;' }, { field: 'payment', width: 120, title: '付款金额', event: 'setSign', style: 'cursor: pointer;' }, { field: 'memo', minWidth: 150, title: '备注', event: 'setSign', style: 'cursor: pointer;' }, { field: 'payment_time', width: 170, title: '付款时间', event: 'setSign', style: 'cursor: pointer;' }
        ]
    ],
    id: 'paymentDataList',
    data: [],
...
$(document).ready(function() {
    layui.use(['table', 'element', 'layer', 'form', 'laydate'], function() {
        ...
        var tab = table.render({
            elem: '#tidPrdList',
            url: 'index.php?m=system&c=InsteadRule&a=getData',
            cols: [
                [
                    { type: 'numbers', width: 50 }, { field: 'title', minWidth: 120, title: '商品名称' }, { field: 'sku_name', minWidth: 120, title: '商品属性' }, { field: 'prd_no', minWidth: 120, title: '商品编码' }, { field: 'take_price', minWidth: 100, title: '拿货单价' }, { field: 'price', minWidth: 100, title: '代拿费用' }, { field: 'num', minWidth: 100, title: '应到数量' }, { field: 'take_num', minWidth: 100, title: '实到数量' }, { field: 'take_fee', minWidth: 100, title: '实到金额' }
                ]
