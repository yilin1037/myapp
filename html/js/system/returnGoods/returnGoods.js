		...
		look_detail:function(){
			...
			layer.open({																																											
				...
				success:function(){
					...
					//获取消费记录信息
					$.ajax({
						url: "/index.php?m=system&c=returnGoods&a=getDetail",
...
function getCustomer(value){
	$.ajax({
		url: "/index.php?m=system&c=returnGoods&a=getCustomer",
		data: {value:value},
		dataType: "json",
		type: "POST",
		success: function (data) {
		...
		success: function (data) {
			if(data){
				...
				var newData = {
					...
					"sku_name":data.sku_name1+";"+data.sku_name2,
					"remark":"",
					"prd_sku_no":data.prd_sku_no,
					"prd_id":data.prd_id,
					"prd_sku_id":data.prd_sku_id,
					"prd_no":data.prd_no,
					"title":data.title+"_"+data.sku_name1+";"+data.sku_name2,
...
function settlement_sure(type){
	...
	$.ajax({
		url: "/index.php?m=system&c=returnGoods&a=setData",
