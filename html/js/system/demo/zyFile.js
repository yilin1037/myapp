...
var ZYFILE = {
		...
		funDealtFiles : function(){
			...
			// 执行选择回调
			this.onSelect(this.uploadFile, this.uploadFile);
			//console.info.info("继续选择");
			//console.info.info(this.uploadFile);
			return this;
		},
