...
layui.use(['laydate', 'form', 'laypage', 'layer', 'element', 'table'], function() {
    ...
    var tab = table.render({
        ...
        cols: [
            [
                { type: 'numbers', width: 100, title: '序号' }, { field: 'system_id', width: 150, title: '系统号' }, { field: 'system_name', width: 150, title: '客户名称' }, { field: 'pay_type_name', width: 100, title: '付费类型' }, { field: 'sort_name', width: 100, title: '简称', edit: 'text' }, { field: 'balance', width: 100, title: '账户余额' }, { field: 'credit_money', width: 100, title: '信用额度', edit: 'text' }, { field: 'price', width: 100, title: '代拿费用', edit: 'text' }, { field: 'take_price', width: 100, title: '基础拿货价', edit: 'text' }, { field: 'linkman', width: 150, title: '联系人', edit: 'text' }, { field: 'phone', width: 200, title: '联系人电话', edit: 'text' }, { field: 'address', minWidth: 200, title: '送货地址', edit: 'text' }, { fixed: 'right', width: 350, title: '操作', align: 'center', toolbar: '#barDemo' }
            ]
        ],
        id: 'dataList',
        page: true,
