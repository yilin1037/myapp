...
var dataListOne = {
	...
	,cols: [[ 
        ...
        ,{field:'cost_price', width:200, title: '单价', edit: 'text'}
...
$("#saveInto").click(function(){
	...
	if(!onOff){
		...
		$.ajax({
			url:'?m=PT&c=Storage&a=setInpurchaseReturn',
			dataType: 'json',
			type: "post",
			data:{
                cus_no:cus_no,
...
var custTableLoad = {
	...
	tableLoadTable:function(){
		...
		$.ajax({
			url:'/?m=PT&c=purchaseReturn&a=getCustTable',
			dataType: 'json',
			type: "post",
			data:{
				custName:custName
...
var whTableLoad = {
	...
	tableLoadTable:function(){
		...
		$.ajax({
			url:'/?m=PT&c=purchaseReturn&a=getWhTable',
			dataType: 'json',
			type: "post",
			data:{
				whName:whName
...
var locTableLoad = {
	...
	tableLoadTable:function(){
		...
		$.ajax({
			url:'/?m=PT&c=purchaseReturn&a=getLocTable',
			dataType: 'json',
			type: "post",
			data:{
				id:id,
